...
void UTP_WeaponComponent::Fire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			World->SpawnActor<AHouseOfDoomProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
		}
	}
...
void UTP_WeaponComponent::AttachWeapon(AHouseOfDoomCharacter* TargetCharacter)
{
